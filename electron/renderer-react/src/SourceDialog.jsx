...
const schema = z.object({
  ...
  note: z.string().trim(),
  links: z.string().min(1, 'Nhập ít nhất một channel link hoặc TikTok channel ID.'),
})
