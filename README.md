...
1. Download and run [Reup-Studio-Setup-1.0.9.exe](https://github.com/dinhvan2310/youtube-tiktok-downloader/releases/download/v1.0.9/Reup-Studio-Setup-1.0.9.exe).
...
`electron/dist/Reup-Studio-Setup-1.0.9.exe`
